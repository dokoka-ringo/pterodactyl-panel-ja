        ...
        <div class="row">
            ...
            <div class="col-xs-12">
                <div class="box box-danger">
                    ...
                    <div class="box-body">
                        <p class="no-margin">ノードの削除は取り消せない操作であり、パネルから直ちにこのノードが削除されます。このノードに関連付けられたサーバーが存在しないことを確認してください。</p>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="info-box bg-{{ $stats['disk']['css'] }}">
                            ...
                            <div class="info-box-content" style="padding: 15px 10px 0;">
                                <span class="info-box-text">ディスク割り当て</span>
                    ...
                    <div class="col-sm-12">
                        <div class="info-box bg-{{ $stats['memory']['css'] }}">
                            ...
                            <div class="info-box-content" style="padding: 15px 10px 0;">
                                <span class="info-box-text">メモリ割り当て</span>
