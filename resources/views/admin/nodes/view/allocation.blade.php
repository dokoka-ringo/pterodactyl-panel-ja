...
@section('content-header')
    <h1>{{ $node->name }}<small>このノード上のサーバーで利用可能な割り当てを管理します。</small></h1>
    <ol class="breadcrumb">
            ...
            <div class="box-body table-responsive no-padding" style="overflow-x: visible">
                <table class="table table-hover" style="margin-bottom:0;">
                    <tr>
                        ...
                        <th>IP アドレス <i class="fa fa-fw fa-minus-square" style="font-weight:normal;color:#d9534f;cursor:pointer;" data-toggle="modal" data-target="#allocationModal"></i></th>
                        <th>IP エイリアス</th>
                        <th>ポート</th>
                        <th>割り当て済み</th>
                        <th>
            ...
            <div class="box box-success">
                ...
                <div class="box-body">
                    <div class="form-group">
                        <label for="pAllocationIP" class="control-label">IP アドレス</label>
                        <div>
                            ...
                            <p class="text-muted small">ポートを割り当てる IP アドレスをここに入力してください。</p>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="pAllocationIP" class="control-label">IP エイリアス</label>
                        <div>
                            <input type="text" id="pAllocationAlias" class="form-control" name="allocation_alias" placeholder="エイリアス" />
                            <p class="text-muted small">これらの割り当てにデフォルトのエイリアスを設定したい場合はここに入力してください。</p>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div>
                            ...
                            <p class="text-muted small">カンマまたはスペースで区切って単一ポートまたはポート範囲を入力してください。</p>
                        </div>
                    </div>
                </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">IP ブロックの割り当てを削除</h4>
            </div>
            ...
            swal({
                ...
                $.ajax({
                    ...
                    swal({
                        ...
                        title: 'エラー',
                        html: true,
                        text: '割り当ての削除中にエラーが発生しました。もう一度お試しください。',
                    });
                });
            });
        } else {
