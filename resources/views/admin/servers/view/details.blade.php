...
@section('content-header')
    <h1>{{ $server->name }}<small>このサーバーの所有者やコンテナを含む詳細を編集します。</small></h1>
    <ol class="breadcrumb">
            ...
            <form action="{{ route('admin.servers.view.details', $server->id) }}" method="POST">
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <p class="text-muted small">使用可能文字: <code>a-zA-Z0-9_-</code> および <code>[スペース]</code>。</p>
                    </div>
                    <div class="form-group">
                        ...
                        <p class="text-muted small">空欄のままにすると外部識別子は割り当てられません。外部IDは他のサーバーと重複しないユニークな値にしてください。</p>
                    </div>
                    <div class="form-group">
                        ...
                        <p class="text-muted small">このフィールドを別のユーザーのメールに変更すると、サーバーの所有者を変更できます。変更すると新しいデーモンセキュリティトークンが自動的に生成されます。</p>
                    </div>
                    <div class="form-group">
                        ...
                        <p class="text-muted small">このサーバーの簡単な説明を入力してください。</p>
                    </div>
                </div>
