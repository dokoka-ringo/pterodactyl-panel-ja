...
@section('content-header')
    <h1>{{ $server->name }}<small>起動コマンドおよび変数を制御します。</small></h1>
    <ol class="breadcrumb">
        ...
        <div class="col-xs-12">
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <p class="small text-muted">サーバーの起動コマンドをここで編集します。デフォルトで使用可能な変数は以下の通りです: <code>@{{SERVER_MEMORY}}</code>、<code>@{{SERVER_IP}}</code>、および <code>@{{SERVER_PORT}}</code>。</p>
                </div>
                <div class="box-body">
                ...
                <div class="box-body row">
                    <div class="col-xs-12">
                        <p class="small text-danger">
                            以下の値を変更すると、サーバーは再インストールコマンドを処理します。サーバーは停止され、その後処理が進行します。
                            サービススクリプトを実行させたくない場合は、下のボックスをチェックしてください。
                        </p>
                        <p class="small text-danger">
                            <strong>多くの場合、これは破壊的な操作です。この操作を実行するためにサーバーは直ちに停止されます。</strong>
                        </p>
                    </div>
                    <div class="form-group col-xs-12">
                        ...
                        <p class="small text-muted no-margin">このサーバーを所属させるネストを選択してください。</p>
                    </div>
                    <div class="form-group col-xs-12">
                    ...
                    <div class="form-group col-xs-12">
                        ...
                        <p class="small text-muted no-margin">選択したEggにインストールスクリプトが添付されている場合、インストール中にスクリプトが実行されます。このステップをスキップしたい場合は、このボックスをチェックしてください。</p>
                    </div>
                </div>
            </div>
            <div class="box">
                ...
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <p class="small text-muted no-margin">このサーバーを実行するために使用するDockerイメージです。ドロップダウンから選択するか、上記のテキストフィールドにカスタムイメージを入力してください。</p>
                    </div>
                </div>
            </div>
        </div>
...
@section('footer-scripts')
    ...
    $(document).ready(function () {
        $('#pEggId').select2({placeholder: 'ネストEggを選択'}).on('change', function () {
