...
<div class="row">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            ...
                            <p class="text-muted"><small>このユーザーのパネル表示時に使用されるデフォルト言語です。</small></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="box-body">
                    ...
                    <div class="form-group no-margin-bottom">
                        ...
                        <div>
                            ...
                            <p class="text-muted small">空欄のままにすると、現在のパスワードは変更されません。変更してもユーザーには通知されません。</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <div>
                            ...
                            <p class="text-muted"><small>「はい」を選択すると、このユーザーに完全な管理者権限が与えられます。</small></p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="col-xs-12">
        <div class="box box-danger">
            ...
            <div class="box-body">
                <p class="no-margin">このアカウントに関連付けられたサーバーがない場合のみ削除できます。</p>
            </div>
            <div class="box-footer">
                <form action="{{ route('admin.users.view', $user->id) }}" method="POST">
                    {!! csrf_field() !!}
