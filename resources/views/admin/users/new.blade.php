                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            ...
                            <p class="text-muted"><small>このユーザーのパネル表示時に使用するデフォルト言語です。</small></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="box-body">
                    <div class="form-group col-md-12">
                        ...
                        <div>
                            ...
                            <p class="text-muted"><small>「はい」を選択すると、このユーザーに完全な管理者権限が付与されます。</small></p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="box">
                ...
                <div class="box-body">
                    <div class="alert alert-info">
                        <p>パスワードの入力は任意です。新しいユーザーには、初回ログイン時にパスワードを設定するメールが送信されます。ここでパスワードを指定した場合は、別の方法でユーザーに通知する必要があります。</p>
                    </div>
