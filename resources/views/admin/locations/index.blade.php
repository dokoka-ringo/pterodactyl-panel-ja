...
@section('content-header')
    <h1>ロケーション<small>ノードが割り当てられるすべてのロケーションで、より簡単にカテゴリ分けできるようにします。</small></h1>
    <ol class="breadcrumb">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <p class="text-muted small">このロケーションを他のロケーションと区別するために使用される短い識別子です。1文字以上60文字以内でなければならず、例えば<code>us.nyc.lvl3</code>のような形式です。</p>
                        </div>
                        <div class="col-md-12">
