                ...
                <form action="{{ route('admin.nests.egg.variables.edit', ['egg' => $egg->id, 'variable' => $variable->id]) }}" method="POST">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <p class="text-muted small">これらのルールは標準の <a href="https://laravel.com/docs/5.7/validation#available-validation-rules" target="_blank">Laravelフレームワークのバリデーションルール</a> を使用して定義されています。</p>
                        </div>
                    </div>
            ...
            <form action="{{ route('admin.nests.egg.variables', $egg->id) }}" method="POST">
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12">
                            <p class="text-muted small">この変数は起動コマンド内で <code>@{{environment variable value}}</code> を入力することでアクセスできます。</p>
                        </div>
                    </div>
                    <div class="form-group">
