...
@section('title')
    Nests &rarr; Egg: {{ $egg->name }} &rarr; インストールスクリプト
@endsection
                ...
                @if(! is_null($egg->copyFrom))
                    <div class="box-body">
                        <div class="callout callout-warning no-margin">
                            このサービスオプションは、<a href="{{ route('admin.nests.egg.view', $egg->copyFrom->id) }}">{{ $egg->copyFrom->name }}</a> からインストールスクリプトとコンテナオプションをコピーしています。下のドロップダウンで「なし」を選択しない限り、このスクリプトに加えた変更は適用されません。
                        </div>
                    </div>
                @endif
                ...
                <div class="box-body">
                    <div class="row">
                        <div class="form-group col-sm-4">
                            <label class="control-label">スクリプトコピー元</label>
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            <p class="text-muted small">サーバー用にこのスクリプトを実行する際に使用するDockerコンテナ。</p>
                        </div>
                        <div class="form-group col-sm-4">
