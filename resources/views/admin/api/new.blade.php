...
@section('content-header')
    <h1>Application API<small>新しいAPIキーを作成します。</small></h1>
    <ol class="breadcrumb">
        <li><a href="{{ route('admin.index') }}">管理</a></li>
        <li><a href="{{ route('admin.api.index') }}">API</a></li>
        <li class="active">新しい資格情報</li>
    </ol>
@endsection
            ...
            <div class="col-sm-4 col-xs-12">
                <div class="box box-primary">
                    <div class="box-body">
                        ...
                        <p class="text-muted">権限を後から変更することはできません。後日変更が必要になった場合は、新しい資格情報を作成する必要があります。</p>
                    </div>
                    <div class="box-footer">
                        {{ csrf_field() }}
                        <button type="submit" class="btn btn-success btn-sm pull-right">資格情報を作成</button>
                    </div>
                </div>
            </div>
        </form>
