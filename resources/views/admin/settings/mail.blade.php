...
@section('content-header')
    <h1>メール設定<small>Pterodactylがメールの送信を処理する方法を設定します。</small></h1>
    <ol class="breadcrumb">
                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                このインターフェースは、メール ドライバーとして SMTP を使用するインスタンスに限定されます。<code>php artisan p:environment:mail</code>コマンドを使用してメール設定を更新するか、環境ファイルで<code>MAIL_DRIVER=smtp</code>に設定してください。
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-muted small">メールの送信に使用するSMTPサーバーアドレスを入力します。</p>
                                    </div>
                                </div>
                                <div class="form-group col-md-2">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-muted small">メールの送信に使用するSMTPサーバーポートを入力します。</p>
                                    </div>
                                </div>
                                <div class="form-group col-md-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-muted small">メールの送信に使用する暗号化方式を選択します。</p>
                                    </div>
                                </div>
                                <div class="form-group col-md-6">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-muted small">SMTPサーバーへの接続に使用するユーザー名を入力します。</p>
                                    </div>
                                </div>
                                <div class="form-group col-md-6">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-muted small">SMTPユーザー名と組み合わせて使用するパスワードを入力します。既存のパスワードを引き続き使用する場合は空白のままにしてください。パスワードを空の値に設定するには、フィールドに<code>!e</code>と入力します。</p>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-muted small">すべてのメールの送信元となるメールアドレスを入力します。</p>
                                    </div>
                                </div>
                                <div class="form-group col-md-6">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-muted small">Eメールの送信元として表示される名前。</p>
                                    </div>
                                </div>
                            </div>
                        </div>
...
@section('footer-scripts')
    ...
    <script>
        ...
        function showErrorDialog(jqXHR, verb) {
            ...
            swal({
                title: 'おっと！',
                text: + verb + ' メール設定を試行中にエラーが発生しました: ' + errorText
                type: 'error'
            });
        }
        ...
        $(document).ready(function () {
            ...
            $('#saveButton').on('click', function () {
                saveSettings().done(function () {
                    swal({
                        title: '成功',
                        text: 'メール設定は正常に更新され、これらの変更を適用するためにキューワーカーが再起動されました。',
                        type: 'success'
                    });
                });
            });
