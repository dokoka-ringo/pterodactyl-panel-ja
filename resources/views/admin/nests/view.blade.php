                ...
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <div>
                            ...
                            <p class="text-muted"><small>サービス内の全オプションを包含する説明的なカテゴリ名にしてください。</small></p>
                        </div>
                    </div>
                    <div class="form-group">
            ...
            <div class="box-body">
                <div class="form-group">
                    ...
                    <div>
                        ...
                        <p class="text-muted small">内部およびAPI経由でこのネストを識別するためのユニークIDです。</p>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div>
                        ...
                        <p class="text-muted small">このサービスオプションの作成者です。公式オプション (<code>support@pterodactyl.io</code>) でない限り、質問や問題は作成者に問い合わせてください。</p>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div>
                        ...
                        <p class="text-muted small">このオプションを使用する全サーバーに割り当てられる識別用のUUIDです。</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-xs-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">ネスト内のEgg</h3>
            </div>
            ...
            <div class="box-footer">
                <a href="{{ route('admin.nests.egg.new') }}"><button class="btn btn-success btn-sm pull-right">新しいEgg</button></a>
            </div>
        </div>
    </div>
</div>
