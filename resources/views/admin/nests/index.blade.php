...
@section('content-header')
    <h1>ネスト<small>このシステムで現在利用可能な全てのネスト。</small></h1>
    <ol class="breadcrumb">
...
<div class="row">
    <div class="col-xs-12">
        <div class="alert alert-danger">
            エッグはプテロダクティルパネルの強力な機能で、極めて柔軟な設定が可能です。強力である一方で、エッグを誤って変更するとサーバーが簡単に壊れ、問題が発生する可能性があります。デフォルトのエッグ <code>support@pterodactyl.io</code> が提供するものは、確信がない限り編集しないでください。
        </div>
    </div>
</div>
<div class="row">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            ...
                            <p class="small text-muted">このエッグを関連付けるネストをドロップダウンから選択してください。新しいネストに関連付けたい場合は、先にそのネストを作成する必要があります。</p>
                        </div>
                    </div>
                </div>
