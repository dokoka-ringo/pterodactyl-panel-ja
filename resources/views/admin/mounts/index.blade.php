                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <p class="text-muted small">このマウントを他のマウントと区別するための一意の名前です。</p>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div>
                                    <div class="radio radio-success radio-inline">
                                        ...
                                        <label for="pReadOnlyFalse">無効</label>
                                    </div>

                                    <div class="radio radio-warning radio-inline">
                                        <input type="radio" id="pReadOnly" name="read_only" value="1">
                                        <label for="pReadOnly">有効</label>
                                    </div>
                                </div>

                                <p class="text-muted small">マウントはコンテナ内で読み取り専用ですか？</p>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div>
                                    <div class="radio radio-success radio-inline">
                                        ...
                                        <label for="pUserMountableFalse">無効</label>
                                    </div>

                                    <div class="radio radio-warning radio-inline">
                                        <input type="radio" id="pUserMountable" name="user_mountable" value="1">
                                        <label for="pUserMountable">有効</label>
                                    </div>
                                </div>

                                <p class="text-muted small">ユーザー自身がマウントできるようにしますか？</p>
                            </div>
                        </div>
                    </div>
